...
int main(void) {
    ...
    for (int ti = 0; ti < nthr; ++ti) {
        ...
        for (int si = 0; si < nsizes; ++si) {
            ...
            /* CSV */
            if (csv) fprintf(csv, "%d,%d,%.6f,%.6f,%.6f,%.6f\n",
                             t, n, total_s, G_TIMERS.dsytrd_s, G_TIMERS.dstedc_s, G_TIMERS.dormtr_s);
