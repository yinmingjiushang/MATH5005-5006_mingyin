...
// Current default configuration is the controlled single-thread SVE-versus-SIMD
// study used in Chapter 4; the default size grid is matched to DSYEV so the
// two routines can be compared directly.
// ------------------------------------------------------------
